            ...
            <div className="w-px h-8 bg-zinc-800 mx-1 hidden sm:block" />
             ...
             {/* Search Bar */}
                ...
                <div className="flex items-center gap-3 ml-auto min-w-fit">    
                    {/* Avatar Icon */}
        <div className="w-9 h-9 rounded-full bg-zinc-800 border border-zinc-700 flex items-center justify-center cursor-pointer hover:border-amber-500/50 transition-colors duration-200">
        <svg
